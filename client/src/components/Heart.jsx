...
function Heart({ post, setPosts, setPost }) {
  const [active, setActive] = useState(false);

  useEffect(() => {
    setActive(post?.isReacted || false);
  }, [post?.isReacted]);
  ...
  const reactPost = async () => {
    ...
    console.log("REACT RESPONSE:", data); // DEBUG

    // ✅ instant UI update
    setActive(data.isReacted);
